...
abstract class BaseproductType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Herb\\FrontendBundle\\Model\\productTypePeer';
    ...
    /**
     * The value for the pt_id field.
     * @var        int
     */
    protected $pt_id;

    /**
     * The value for the pt_name field.
     * @var        string
     */
    protected $pt_name;
    ...
    /**
     * Set the value of [pt_id] column.
     *
     * @param int $v new value
     * @return productType The current object (for fluent API support)
     */
    public function setptId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->pt_id !== $v) {
            $this->pt_id = $v;
            $this->modifiedColumns[] = productTypePeer::PT_ID;
        }
    ...
    /**
     * Set the value of [pt_name] column.
     *
     * @param string $v new value
     * @return productType The current object (for fluent API support)
     */
    public function setptName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->pt_name !== $v) {
            $this->pt_name = $v;
            $this->modifiedColumns[] = productTypePeer::PT_NAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = productTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = productTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->pt_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->pt_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = productTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating productType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = productTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = productTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(productTypePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(productTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(productTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                productTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(productTypePeer::PT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`PT_ID`';
        }
        if ($this->isColumnModified(productTypePeer::PT_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`PT_NAME`';
        }
        if ($this->isColumnModified(productTypePeer::CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO `edf_productType` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`PT_ID`':
                        $stmt->bindValue($identifier, $this->pt_id, PDO::PARAM_INT);
                        break;
                    case '`PT_NAME`':
                        $stmt->bindValue($identifier, $this->pt_name, PDO::PARAM_STR);
                        break;
                    case '`CREATED_AT`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = productTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = productTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['productType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['productType'][$this->getPrimaryKey()] = true;
        $keys = productTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getptId(),
            $keys[1] => $this->getptName(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setptId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setptName($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(productTypePeer::PT_ID)) $criteria->add(productTypePeer::PT_ID, $this->pt_id);
        if ($this->isColumnModified(productTypePeer::PT_NAME)) $criteria->add(productTypePeer::PT_NAME, $this->pt_name);
        if ($this->isColumnModified(productTypePeer::CREATED_AT)) $criteria->add(productTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(productTypePeer::UPDATED_AT)) $criteria->add(productTypePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(productTypePeer::DATABASE_NAME);
        $criteria->add(productTypePeer::PT_ID, $this->pt_id);
    ...
    /**
     * Generic method to set the primary key (pt_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of productType (or compatible) type.
    ...
    {
        $copyObj->setptName($this->getptName());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setptId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return productType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return productTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new productTypePeer();
        }
     ...
     * If this productType is new, it will return
    ...
    public function setproductss(PropelCollection $productss, PropelPDO $con = null)
    {
        ...
        foreach ($this->productssScheduledForDeletion as $productsRemoved) {
            $productsRemoved->setproductType(null);
        }
    ...
    {
        return (string) $this->exportTo(productTypePeer::DEFAULT_STRING_FORMAT);
    }
